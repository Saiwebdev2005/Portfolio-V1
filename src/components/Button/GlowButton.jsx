...
const Button = ({ buttonText,className }) => {
  return (
    <div className=" w-full flex items-center justify-center">
      <a href="#_" className={`relative inline-block text-lg group transform transition-transform duration-500 hover:scale-110 ${className}`}>
        ...
        <span className="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-c3 rounded-lg group-hover:mb-0 group-hover:mr-0" data-rounded="rounded-lg"></span>
      </a>
    </div>
  );
};
