...
const Card = ({
  ...
  return (
    <div
      className={`flex flex-col rounded-lg border ${borderColor} bg-gradient-to-r ${gradientColors} shadow-[rgba(0,_0,_0,_0.4)_20px_30px_120px] ${shadowColor} w-24 justify-center -my-2 md:my-0`}
    >
      <div
